    ...
    private void onLoad() {
        switch (PageManager.getInstance().getHistoryPages().get(PageManager.getInstance().getHistoryPages().size() - 1)) {
            ...
            case Gaming:
                ...
                break;
            case Profile:
                DescText.setText("Your name, employee type, email, phone number, and address within the hospital are listed in the \"Info\" section of your user profile to review." +
                        "\nPlease keep these details consistent and notify an administrator when they change.\n" +
                        "Requests you have made are listed in the \"My Requests\" section of your user profile.\n");
                break;
            case AdminHub:
                DescText.setText("Employee Manager:\n" +
                        ...
                        "7. By selecting the edit mode, you can click on the map to create a new location.\n" +
                        "Input all of the relevant fields to place the location where you clicked. It may then be used for requests and equipment storage.\n" +
                ...
                Pic.setImage(new Image("edu/wpi/cs3733/d22/teamW/wApp/assets/HelpImages/AdminHelp.png"));
                break;
            case FlowerSR:
            ...
            case Dashboard:
                ...
                Pic.setImage(new Image("edu/wpi/cs3733/d22/teamW/wApp/assets/HelpImages/DashboardHelp.png"));
                break;
            case MainMenu:
                ...
                Pic.setImage(new Image("edu/wpi/cs3733/d22/teamW/wApp/assets/HelpImages/MainMenuHelp.png"));
                break;
            case EquipList:
                DescText.setText("1. The equipment list displays all of the equipment in the hospital, their locations, and their statuses.\n" +
                        "\n" +
                        "2. Use the \"Add New Equip\" button and fill in the relevant data to add a new piece of equipment to the system.\n" +
                        "3. Use the \"Delete Equip\" button to delete the currently selected equipment\n" +
                        "4. Input a location and select \"Move To\" to move the selected equipment to the input location\n" +
                        "5. Use the \"Mark Selected Clean\" button to change the selected equipment's status to clean.\n" +
                        "6. Use the \"Mark Selected In-Use\" button to change the selected equipment's status to in-use.\n" +
                        "7. Use the \"Mark Selected Dirty\" button to change the selected equipment's status to dirty.\n");
                Pic.setImage(new Image("edu/wpi/cs3733/d22/teamW/wApp/assets/HelpImages/EquipListHelp.png"));
                break;
            case Messaging:
                DescText.setText("To begin a conversation with another employee:\n" +
                        ...
                        "1. Click on the \"Create Group Chat\" button\n" +
                        "2. Input or select the name of each employee you wish to chat with from the list of employees.\n" +
                        "3. Click the \"Submit\" button.\n" +
                        "4. Chat with your employees the same way you would with a single-employee chat. Be sure to follow company policy when conversing with other employees!\n" +
                        "\n" +
            ...
            case MapEditor:
                DescText.setText("This page displays the entire map of the hospital, and allows you to add, edit, and remove locations.\n" +
                        "By using the controls, you may drag or zoom into/out of the map.\n" +
                        "By selecting the edit mode, you can click on the map to create a new location. Input all of the relevant fields to place the location where you clicked." +
                        "\nIt may then be used for requests and equipment storage.\n" +
                        "The floor dropdown menu allows you to change which floor you are currently viewing.\n" +
                        "The location table displays a list of all locations on the current floor, as well as their horizontal and vertical positions on the map (listed as X and Y, respectively.)\n" +
                        "The equipment table displays a list of all equipment on the current floor, their IDs, and the horizontal and vertical locations.\n" +
                        "Using the filters, you may selectively view only locations, equipment, requests, or any combination of the three.\n" +
                        "The locations and the various types of equipment are given different icons that are displayed on the map.\n" +
                        "The map may be saved or loaded as a CSV file for archival purposes.\n");
                break;
            case ComputerSR:
            ...
            case RequestList:
                DescText.setText("1. The request list displays all of the requests tracked by the request system, their request types, their assigned employee, their status, and any other important details.\n" +
                        ...
                        "\n" +
                        "5. By selecting a request, it may be marked as Started, Complete, or Canceled. \"Requeue\" will return a Canceled request to In-Progress." +
                        "\n\"Clear Selection\" will deselect the currently selected request.\n");
                Pic.setImage(new Image("edu/wpi/cs3733/d22/teamW/wApp/assets/HelpImages/RequestListHelp.png"));
                break;
            case SanitationSR:
