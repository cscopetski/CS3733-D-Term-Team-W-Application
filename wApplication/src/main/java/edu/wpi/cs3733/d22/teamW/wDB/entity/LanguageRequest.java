...
public class LanguageRequest extends Request{
    ...
    public LanguageRequest(ArrayList<String> fields)
            throws StatusError {
    ...
    public LanguageRequest(Integer index, ArrayList<String> fields)
            throws StatusError{
    ...
    @Override
    public RequestType getRequestType() { return RequestType.LanguageRequest; }
}
